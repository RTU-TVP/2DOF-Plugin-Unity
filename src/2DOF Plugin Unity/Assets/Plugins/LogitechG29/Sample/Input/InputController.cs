...
public partial class @InputController: IInputActionCollection2, IDisposable
{
    ...
    ~@InputController()
    {
        Debug.Assert(!m_Buttons.enabled, "This will cause a leak and performance issues, InputController.Buttons.Disable() has not been called.");
        Debug.Assert(!m_Steeringwheel.enabled, "This will cause a leak and performance issues, InputController.Steeringwheel.Disable() has not been called.");
        Debug.Assert(!m_Pedals.enabled, "This will cause a leak and performance issues, InputController.Pedals.Disable() has not been called.");
        Debug.Assert(!m_Transmission.enabled, "This will cause a leak and performance issues, InputController.Transmission.Disable() has not been called.");
        Debug.Assert(!m_Handbrake.enabled, "This will cause a leak and performance issues, InputController.Handbrake.Disable() has not been called.");
    }
